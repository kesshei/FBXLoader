...
{                                   // 顶点结构
	...
	FLOAT _u, _v;                   // 纹理坐标
	CUSTOMVERTEX2(FLOAT x, FLOAT y, FLOAT z, FLOAT u, FLOAT v)
...
LPD3DXMESH          g_pCubeMesh2 = NULL;  // 立方体网格
LPDIRECT3DTEXTURE9  g_pTextures2[3] = { 0 }; // 网格的纹理
...
HRESULT Objects_Init()
{
	...
	g_pCubeMesh2->LockVertexBuffer(0, (void**)&pVertices2);

	// 正面顶点数据
	pVertices2[0] = CUSTOMVERTEX2(-10.0f, 10.0f, -10.0f, 0.0f, 0.0f);
	pVertices2[1] = CUSTOMVERTEX2(10.0f, 10.0f, -10.0f, 10.0f, 0.0f);
	pVertices2[2] = CUSTOMVERTEX2(10.0f, -10.0f, -10.0f, 10.0f, 1.0f);
	pVertices2[3] = CUSTOMVERTEX2(-10.0f, -10.0f, -10.0f, 0.0f, 1.0f);

	// 背面顶点数据
	pVertices2[4] = CUSTOMVERTEX2(10.0f, 10.0f, 10.0f, 0.0f, 0.0f);
	pVertices2[5] = CUSTOMVERTEX2(-10.0f, 10.0f, 10.0f, 1.0f, 0.0f);
	pVertices2[6] = CUSTOMVERTEX2(-10.0f, -10.0f, 10.0f, 1.0f, 1.0f);
	pVertices2[7] = CUSTOMVERTEX2(10.0f, -10.0f, 10.0f, 0.0f, 1.0f);

	// 顶面顶点数据
	pVertices2[8] = CUSTOMVERTEX2(-10.0f, 10.0f, 10.0f, 0.0f, 0.0f);
	pVertices2[9] = CUSTOMVERTEX2(10.0f, 10.0f, 10.0f, 1.0f, 0.0f);
	pVertices2[10] = CUSTOMVERTEX2(10.0f, 10.0f, -10.0f, 1.0f, 1.0f);
	pVertices2[11] = CUSTOMVERTEX2(-10.0f, 10.0f, -10.0f, 0.0f, 1.0f);

	// 顶面顶点数据
	pVertices2[12] = CUSTOMVERTEX2(-10.0f, -10.0f, -10.0f, 0.0f, 0.0f);
	pVertices2[13] = CUSTOMVERTEX2(10.0f, -10.0f, -10.0f, 1.0f, 0.0f);
	pVertices2[14] = CUSTOMVERTEX2(10.0f, -10.0f, 10.0f, 1.0f, 1.0f);
	pVertices2[15] = CUSTOMVERTEX2(-10.0f, -10.0f, 10.0f, 0.0f, 1.0f);

	// 左侧面顶点数据
	pVertices2[16] = CUSTOMVERTEX2(-10.0f, 10.0f, 10.0f, 0.0f, 0.0f);
	pVertices2[17] = CUSTOMVERTEX2(-10.0f, 10.0f, -10.0f, 1.0f, 0.0f);
	pVertices2[18] = CUSTOMVERTEX2(-10.0f, -10.0f, -10.0f, 1.0f, 1.0f);
	pVertices2[19] = CUSTOMVERTEX2(-10.0f, -10.0f, 10.0f, 0.0f, 1.0f);

	// 右侧面顶点数据
	pVertices2[20] = CUSTOMVERTEX2(10.0f, 10.0f, -10.0f, 0.0f, 0.0f);
	pVertices2[21] = CUSTOMVERTEX2(10.0f, 10.0f, 10.0f, 1.0f, 0.0f);
	pVertices2[22] = CUSTOMVERTEX2(10.0f, -10.0f, 10.0f, 1.0f, 1.0f);
	pVertices2[23] = CUSTOMVERTEX2(10.0f, -10.0f, -10.0f, 0.0f, 1.0f);
	g_pCubeMesh2->UnlockVertexBuffer();

	// 填充索引数据
	WORD* pIndices = NULL;
	g_pCubeMesh2->LockIndexBuffer(0, (void**)&pIndices);
	...
	g_pCubeMesh2->UnlockIndexBuffer();

	// 填充属性表数据
	DWORD* pAttrib = NULL;
	g_pCubeMesh2->LockAttributeBuffer(0, &pAttrib);
	for (int a = 0; a < 4; a++) pAttrib[a] = 0;
	for (int b = 4; b < 8; b++) pAttrib[b] = 1;
	for (int c = 8; c < 12; c++) pAttrib[c] = 2;
	g_pCubeMesh2->UnlockAttributeBuffer();

	// 创建纹理
	D3DXCreateTextureFromFile(g_pd3dDevice, L"crate.jpg", &g_pTextures2[0]);
	D3DXCreateTextureFromFile(g_pd3dDevice, L"lion.jpg", &g_pTextures2[1]);
	D3DXCreateTextureFromFile(g_pd3dDevice, L"wood.jpg", &g_pTextures2[2]);
