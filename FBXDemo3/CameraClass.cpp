...
CameraClass::CameraClass(IDirect3DDevice9 *pd3dDevice)
{
    ...
    m_vCameraPosition  = D3DXVECTOR3(0.0f, 0.0f, -20.0f);   // 默认摄像机坐标为(0.0f, 0.0f, -250.0f)
...
VOID CameraClass::SetProjMatrix(D3DXMATRIX *pMatrix) 
{
    ...
    else D3DXMatrixPerspectiveFovLH(&m_matProj, D3DX_PI / 4.0f, (float)((double)WINDOW_WIDTH/WINDOW_HEIGHT), 1.0f, 30000.0f);//视截体远景设为30000.0f，这样就不怕看不到远处的物体了
